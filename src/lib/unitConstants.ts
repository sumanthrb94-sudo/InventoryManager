 ...
 * the same request (2026-09-22), then 'Navy' when the operator saw the
 * shipped list; Blue and Black were already present.
 *
 ...
 */
export const COLOUR_PRESETS = ['Black', 'White', 'Grey', 'Blue', 'Silver', 'Purple', 'Violet', 'Navy'] as const;
