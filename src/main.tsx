...
// Any lazy-loaded code-split chunk then fails with "Failed to fetch
// dynamically imported module" or "Failed to load module script" —
// and the failure is permanent for the lifetime of the tab unless we
// reload.
//
